let component = React.statelessComponent("IconIceCream");
...
let make = _children => {
  ...
  render: _self =>
    <svg
      className="icon ion-ios-ice-cream"
      viewBox="0 0 512 512">
      <g>
        <path
      ...
      C222.2,402.8,220.3,404.3,220.8,406.1z"
        />
        <path
          d="M286.6,421l4.9-15.2c0.6-1.8-1.4-3.3-3-2.3l-11.9,7.4c-2.5,1.6-2.5,5.2,0,6.8l7,4.4C284.8,422.8,286.2,422.2,286.6,421z"
        />
        <path
